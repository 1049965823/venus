...
from venus.db.sqlalchemy import api as sqla_api
from venus import i18n
from venus import objects
from venus import rpc
from venus import service
from venus.tests import fixtures as venus_fixtures
from venus.tests.unit import conf_fixture
from venus.tests.unit import fake_notifier
...
class TestCase(testtools.TestCase):
    ...
    def setUp(self):
        ...
        p = mock.patch('venus.rpc.get_notifier',
                       side_effect=self._get_joined_notifier)
        p.start()

        # Import venus objects for test cases
        ...
        self.useFixture(venus_fixtures.StandardLogging())

        rpc.add_extra_exmods("venus.tests.unit")
    ...
    def start_service(self, name, host=None, **kwargs):
        ...
        kwargs.setdefault('binary', 'venus-%s' % name)
