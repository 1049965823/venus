...
ignore_messages = ["An attribute affected in venus.tests",
...
# checked elsewhere. We also ignore venus.tests for now due to high false
# positive rate.
ignore_modules = ["venus/openstack/common/", "venus/tests/"]

# Note(thangp): E0213, E1101, and E1102 should be ignored for only
# venus.object modules. E0213 and E1102 are error codes related to
...
# the venus code base using objects. E1120 is an error code related no value
...
objects_ignore_messages = [
    ...
    "Module 'venus.objects' has no 'Snapshot' member",
    "Module 'venus.objects' has no 'SnapshotList' member",
    "Module 'venus.objects' has no 'Backup' member",
    "Module 'venus.objects' has no 'BackupList' member",
    "Module 'venus.objects' has no 'Service' member",
    "Module 'venus.objects' has no 'ServiceList' member",
    "Module 'venus.objects' has no 'BackupImport' member",
    "Module 'venus.objects' has no 'ConsistencyGroup' member",
    "Module 'venus.objects' has no 'ConsistencyGroupList' member",
]
objects_ignore_modules = ["venus/objects/"]
